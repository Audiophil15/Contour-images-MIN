...
testShapeTools.o : testShapeTools.c shapeTools.h image_pbm.h geometrie2D.h TTVcontour.h
	@echo ""
	@echo "---------------------------------------------"
...
Contour.o : Contour.c shapeTools.h image_pbm.h geometrie2D.h TTVcontour.h
TTVcontour.o : geometrie2D.h
...
testShapeTools : testShapeTools.o image_pbm.o shapeTools.o geometrie2D.o TTVcontour.o
	$(CC) $^ $(LDOPTS) -o $@

Contour : Contour.o image_pbm.o shapeTools.o geometrie2D.o TTVcontour.o
	$(CC) $^ $(LDOPTS) -o $@
